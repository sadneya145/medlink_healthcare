...
def generate_receipt_pdf(consultation_fee ,lab_test_fee,medication_fee, patient_id,other_fees, doctor_name, appointment_details, total_amount):
    ...
    pdf_canvas.drawString(100, 700, f"Appointment Time: {appointment_details[1]}")

    pdf_canvas.drawString(100, 680, "-" * 50)
    pdf_canvas.drawString(100, 660, "Total Amount: ${:.2f}".format(total_amount))
...
def get_patient_name(patient_id):
    try:
        ...
        cursor.execute("SELECT Name FROM patient_info WHERE id = %s", (patient_id,))
...
def generate_healthcare_receipt(appointment_id, patient_id):
    ...
    generate_receipt_pdf(consultation_fee ,lab_test_fee,medication_fee, patient_id,other_fees, doctor_name, (appointment_date, appointment_time), total_amount)
...
def view_patient_profile_and_bill(appointment_id, patient_id):
    ...
    give_bill_button = tk.Button(patient_profile_window, text="Give Bill", command=lambda app_id=appointment_id, pat_id=patient_id: generate_healthcare_receipt(app_id,pat_id))
