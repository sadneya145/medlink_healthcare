...
def create_signup_window(user_type):
    ...
    def login():
        ...
        login_window.geometry("800x500")  # Adjust the size as needed
        ...
        # Entry fields
        tk.Label(login_window, text="Contact: ").pack(pady=10)
        contact_entry = tk.Entry(login_window, width=30)
        ...
        def user_login():
            if user_type == "Doctor":
                ...
                d_login(contact_entry.get(), password_entry.get())
            elif user_type == "Patient":
                # Call patient login function
                p_login(contact_entry.get(), password_entry.get())
